...
import '/components/confirmationcard1_widget.dart';
                ...
                children: [
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        final foodResInfoUpdateData =
                            createFoodResInfoRecordData(
                          orderPicked: true,
                        );
                        await restaurantAddFoodInfoPageFoodResInfoRecord
                            .reference
                            .update(foodResInfoUpdateData);
