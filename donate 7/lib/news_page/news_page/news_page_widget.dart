                ...
                child: Container(
                  ...
                  child: StreamBuilder<List<NgoRecord>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      List<NgoRecord> horizontalListNgoRecordList =
                          snapshot.data!;
                      return ListView.builder(
                        ...
                        itemCount: horizontalListNgoRecordList.length,
                        itemBuilder: (context, horizontalListIndex) {
                          final horizontalListNgoRecord =
                              horizontalListNgoRecordList[horizontalListIndex];
                          return Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                16.0, 8.0, 16.0, 10.0),
                            child: StreamBuilder<NgoRecord>(
                              stream: NgoRecord.getDocument(
                                  horizontalListNgoRecord.reference),
                              builder: (context, snapshot) {
                                // Customize what your widget looks like when it's loading.
                                if (!snapshot.hasData) {
                                  return Center(
                                ...
                                final containerNgoRecord = snapshot.data!;
                                return InkWell(
                                  onTap: () async {
                                    context.pushNamed(
                                      'Ngo_info_page',
                                      ...
                                      children: [
                                        ClipRRect(
                                          ...
                                          child: CachedNetworkImage(
                                            imageUrl: containerNgoRecord.image!,
                                            width: double.infinity,
                                            height: 110.0,
                                            fit: BoxFit.cover,
                                          ),
                                  ...
                                  child: StreamBuilder<List<ArticlesRecord>>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      return ListView.builder(
                                        ...
                                        itemCount:
                                            listViewArticlesRecordList.length,
                                          ...
                                          return Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 0.0, 0.0, 12.0),
                                            child:
                                                StreamBuilder<ArticlesRecord>(
                                              stream:
                                                  ArticlesRecord.getDocument(
