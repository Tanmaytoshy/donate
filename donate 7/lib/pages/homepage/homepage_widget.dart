                    ...
                    AuthUserStreamWidget(
                      builder: (context) => Column(
                        ...
                        children: [
                          ...
                          PagedListView<DocumentSnapshot<Object?>?, NgoRecord>(
                            pagingController: () {
                        ...
                        builder: (context) =>
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<FoodResInfoRecord>
                                listViewFoodResInfoRecordList = snapshot.data!;
                            return ListView.builder(
                              padding: EdgeInsets.zero,
                              primary: false,
                              shrinkWrap: true,
                              scrollDirection: Axis.vertical,
                              itemCount: listViewFoodResInfoRecordList.length,
                                ...
                                return Padding(
                                  ...
                                  child: StreamBuilder<FoodResInfoRecord>(
                                    stream: FoodResInfoRecord.getDocument(
                                        listViewFoodResInfoRecord.reference),
                                    builder: (context, snapshot) {
                                      // Customize what your widget looks like when it's loading.
                                      if (!snapshot.hasData) {
                                        return Center(
